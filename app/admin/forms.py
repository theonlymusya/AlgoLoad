...
class VarsCreation(FlaskForm):
    ...
    p1 = StringField(
        "p1",
        default=params["p1"],
        description="Pависимость в одномерном гнезде.",
        validators=[DataRequired()],
    )
    p2 = StringField(
        "p2",
        default=params["p2"],
        description="Зависимость по i в двумерном гнезде.",
        validators=[DataRequired()],
    )
    p3 = StringField(
        "p3",
        default=params["p3"],
        description="Зависимость по j в двумерном гнезде.",
        validators=[DataRequired()],
    )
    p4 = StringField(
        "p4",
        default=params["p4"],
        description="Дуги из одномерного гнезда идут или нет в двумерное, дуги из двумерного идут или нет в трёхмерное.",
        validators=[DataRequired()],
    )
    p5 = StringField(
        "p5",
        default=params["p5"],
        description="Зависимость в трёхмерном гнезде либо от первой итерации по k, либо от (k-1)-ой.",
        validators=[DataRequired()],
    )
    p6 = StringField(
        "p6",
        default=params["p6"],
        description="Зависимость в трёхмерном гнезде либо вдоль i, либо вдоль j.",
        validators=[DataRequired()],
    )
    var_name = StringField(
        "Название варианта", default="new_variant", validators=[DataRequired()]
    )
