...
// https://unpkg.com/@seregpie/three.text-texture
                ...
                c = (() => {
                    ...
                    return (s, h, c) => {
                        if ((a.set(n(), o()), a.x && a.y)) {
                            ...
                            if (
                                (c.isPerspectiveCamera &&
                                    (n *=
                                        2 *
                                        Math.tan(
                                            t.MathUtils.degToRad(c.fov) / 2
                                        )),
                                (c.isPerspectiveCamera ||
                                    c.isOrthographicCamera) &&
                                    (n /= c.zoom),
                                n)
                            ) {
                                var f, d;
    ...
    let i = class extends e {
        ...
        get font() {
            return (function (t, e, i, n, o) {
                ...
                return (
                    (r.style.font = "1px serif"),
                    (r.style.fontFamily = t),
                    (r.style.fontSize = "".concat(e, "px")),
                    (r.style.fontStyle = i),
                    (r.style.fontVariant = n),
                    (r.style.fontWeight = o),
                    r.style.font
                );
            })(
                this.fontFamily,
            ...
            let c = l.length,
                ...
                d = c
                    ? (() => {
                          ...
                          return (
                              (t.font = n),
                              Math.max(...l.map((e) => t.measureText(e).width))
                          );
                      })()
                    : 0,
                g = a + h / 2,
