...
public:
  ...
  enum {
    ...
    RuleIfStatement = 4, RuleElifChain = 5, RuleElseBranch = 6, RuleForStatement = 7, 
    RuleForStart = 8, RuleForStartExpr = 9, RuleForStop = 10, RuleForStep = 11, 
    RuleForStepExpr = 12, RuleAssignmentOp = 13, RuleDeclaration = 14, RuleVarName = 15, 
    RuleArrayDecl = 16, RuleMathExpr = 17, RuleLogicalOrExpr = 18, RuleLogicalAndExpr = 19, 
    RuleEqualityExpr = 20, RuleRelationalExpr = 21, RuleAdditiveExpr = 22, 
    RuleMultiplicativeExpr = 23, RuleUnaryExpr = 24, RulePrimaryExpr = 25, 
    RuleFuncCall = 26, RuleFuncName = 27
  };
  ...
  public:
    small_c_grammarParser::MathExprContext *cond = nullptr;
    IfStatementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    StatementContext *statement();
    MathExprContext *mathExpr();
    ElifChainContext *elifChain();
  ...
  class  ElifChainContext : public antlr4::ParserRuleContext {
  public:
    small_c_grammarParser::MathExprContext *mathExprContext = nullptr;
    std::vector<MathExprContext *> elifCond;
    ElifChainContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<StatementContext *> statement();
    StatementContext* statement(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    std::vector<ForStartExprContext *> forStartExpr();
    ForStartExprContext* forStartExpr(size_t i);
  ...
  class  ForStartExprContext : public antlr4::ParserRuleContext {
  public:
    ForStartExprContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    AssignmentOpContext *assignmentOp();
  ...
  ForStartExprContext* forStartExpr();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    std::vector<ForStepExprContext *> forStepExpr();
    ForStepExprContext* forStepExpr(size_t i);
  ...
  class  ForStepExprContext : public antlr4::ParserRuleContext {
  public:
    ForStepExprContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  ForStepExprContext* forStepExpr();
